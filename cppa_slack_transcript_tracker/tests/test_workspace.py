...
def test_get_workspace_root_returns_path_from_config():
    ...
    with patch("cppa_slack_transcript_tracker.workspace.get_workspace_path") as mock_get:
...
def test_get_data_dir_returns_data_subdir_and_creates_it():
    ...
    with patch("cppa_slack_transcript_tracker.workspace.get_workspace_root") as mock_root:
